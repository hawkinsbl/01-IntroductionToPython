...
#   ch)ange this _TODO_ to DONE and  ** continue to the next _TODO_ (below). **
#
###############################################################################
...
natasha.pen = rg.Pen('blue', 200)  # Second argument is the Pen's thickness
...
natasha.go_to(rg.Point(150,100))
natasha.go_to(rg.Point(100,200))
